...
<table border="1" cellpadding="1" cellspacing="0" style="border-collapse: separate; border-spacing: 0px;" width="100%"> 
 <tbody>
  ...
  <tr>
   <td><p><strong>Patrón</strong></p> <p>Service no convierte los formularios PDF de color en formularios adaptables.</p> <p> </p> <p><strong>Resolución</strong></p> <p>Utilice formularios PDF en blanco y negro o en escala de grises. </p> </td> 
   <td style="text-align: left;"> <img src="assets/coloured-form.png" /></td> 
  </tr>
  <tr>
   <td><p><strong>Patrón</strong></p> <p>Service no convierte los formularios PDF rellenados en formularios adaptables.</p> <p> </p> <p><strong>Resolución</strong></p> <p>Utilice formularios adaptables vacíos.</p> </td> 
