...
description: Ejecutar el servicio de conversión automatizada de Forms para convertir PDF forms en formularios adaptables
seo-description: Ejecutar el servicio de conversión automatizada de Forms para convertir PDF forms en formularios adaptables
...
* **Añada las etiquetas de texto de Adobe Sign a los documentos PDF de origen:** Cuando un formulario PDF de origen tiene etiquetas [de texto de](https://helpx.adobe.com/sign/using/text-tag.html)Adobe Sign, el servicio conserva toda la información relacionada con Adobe Sign durante la conversión. El formulario adaptable generado asocia la información del firmante presente en AcroForm con los campos de formulario adaptables y mantiene los datos intactos relacionados con los campos de formulario adaptables correspondientes al enviar el formulario adaptable al servicio de firma Adobe para la firma. La función solo está disponible para AcroForms y las propiedades del formulario adaptable se alinean exactamente con las propiedades de AcroForm <br>\
